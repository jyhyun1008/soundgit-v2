...
export default function Controller(props) {
    ...
    return (
                ...
                <div id="player-list" className="mainbox">
                    <div id="player-overflow">
                        {musicList.map((music, index)=>(
                            <div className="play-title-box" key={index}>
                                <div className="play-play-box" id="playbox">
                                ...
                                <a href={`/${music}`}><div className="play-link-box">
        ...
        <audio style={{display:'none'}} volume={volume} onEnded={() => endingFunction()} ref={audioRef}></audio>
        </>
    );
}
